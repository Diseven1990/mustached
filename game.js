const canvas = document.getElementById("game");
    ...
    const winCharacterImage = "assets/player/player_01.png";
    const koCharacterImage = "assets/player/player_02.png";

    const backgroundImage = new Image();
    backgroundImage.src = "assets/player/player_03.png";

    const characterFrameSources = [
      "assets/player/player_04.png",
      "assets/player/player_05.png",
      "assets/player/player_06.png",
      "assets/player/win.png",
      "assets/player/ko.png",
      "assets/player/image_09.png"
    ];
    ...
    function setMusicMode(mode) {
      ...
      if(mode === "chaos") {
        ...
        musicMaster.gain.setTargetAtTime(0.11, musicCtx.currentTime, 0.20);
      } else {
        musicFilter.frequency.setTargetAtTime(1400, musicCtx.currentTime, 0.25);
        musicMaster.gain.setTargetAtTime(0.095, musicCtx.currentTime, 0.20);
      }
    }
    ...
    function resize() {
      ...
      player.gravity = isMobile ? 0.38 : 0.44;
      player.jump = isMobile ? -7.6 : -8.3;
      if(!gameStarted) {
        player.x = w * 0.50;
      } else {
    ...
    function mascotSVG(dead=false) {
      return "assets/player/image_10.png";
    }
    ...
    function drawSoftSpeedLines() {
      ...
      const energyLines = reduceFX ? 0 : 10;
    ...
    function addParticles(x,y,n=8) {
      if(lowPowerMode) n = Math.min(n, 1);
    ...
    function spawnChaosObject() {
      ...
      if(frame % (lowPowerMode ? 30 : 14) !== 0) return;
      if(chaosObjects.length > (lowPowerMode ? 3 : 16)) return;
